...
setOptions2(){
  ...
  getWFdataByStartDate(dates?:any): Observable<wfData>{  
    let url = "https://whiteboard.partners.org/esb/FLwbe/QAdashBd/getPlansByStartDate242.php";			// 
    if (isDevMode())
      url =  "https://whiteboard.partners.org/esb/FLwbe/QAdashBd/dev/getPlansByStartDate242.php?userid="+this.userid;  
